"""Add retrieval evaluation minimum source coverage metrics.
...
def upgrade():
    """Persist prompt-safe minimum source coverage aggregates."""
...
def downgrade():
    """Remove prompt-safe minimum source coverage aggregates."""
    _drop_column_if_present("retrieval_evaluation_run", "min_source_count_pass_rate")
    _drop_column_if_present("retrieval_evaluation_run", "min_source_count_fail_count")
